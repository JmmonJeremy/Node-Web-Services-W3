...
const updateContact = async (req, res, next) => {
  try { 
    ...
    console.log (`${name}'s contact info with the id of "${contactId}" is being updated as follows:\n${JSON.stringify(req.body, null, 2)}`);
...
module.exports = { getAllContacts, getSpecificContact, createContact, updateContact, removeContact };